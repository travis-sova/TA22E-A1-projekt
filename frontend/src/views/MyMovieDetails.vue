...
<template>
  <div class="container mx-auto p-6">
    <div
      class="card shadow-xl dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg"
    >
      <div class="flex">
        <figure class="w-1/3">
        ...
        <div class="card-body w-2/3 p-6">
          ...
          <div class="flex justify-between items-center mt-6">
            ...
            >
              <div class="stat">
                <div class="stat-title text-gray-500 dark:text-gray-400">Available Seats</div>
                <div class="stat-value text-gray-900 dark:text-white">{{ movie.seats }}</div>
              </div>
              <div class="stat">
                <div class="stat-title text-gray-500 dark:text-gray-400">Rating</div>
