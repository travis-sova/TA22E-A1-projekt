...
<template>
  <div>
    <h1 class="ml-5 mt-3 text-2xl font-bold text-primary-content">My Settings</h1>
    <!-- Mingi profiilikaart -->
    <div class="flex flex-row justify-center h-content p-5 m-5 text-primary-content">
      <div class="flex flex-col items-center">
        <h1>John Doe</h1>
        <div class="flex flex-row items-center">
          <img src="@/assets/star.png" alt="star" class="w-auto h-5 mr-1" />
          <h1>Spinning rat's club member</h1>
        </div>
      </div>
    ...
    <!-- erinevad lahtrid -->
    <div class="grid grid-cols-4 justify-around text-primary-content">
      <div></div>
      <!-- emaili lahter -->
      <div>
        <div class="flex flex-row items-center">
      ...
      <div>
        ...
        <div class="flex flex-row items-center">
          ...
          <input type="text" v-model="password" :disabled="isDisabled2"
            class="input input-bordered w-full max-w-xs bg-base-200" />
        </div>
      </div>
      <!-- Sünnikuupäev -->
      <div>
        <div class="flex flex-row items-center">
          ...
          <h1 class="">My Date of Birth</h1>
        </div>
        <div class="flex flex-row items-center">
          <input type="text" value="01/01/2000" disabled class="input input-bordered w-full max-w-xs bg-base-200" />
          <h1 class="text-primary-content alert alert-warning p-0 ml-1 w-2/5 text-center">Contact support to change DOB
          </h1>
        </div>
      </div>
      <div></div>
        ...
        <div class="col-start-3">
          <div class="form-control">
            <label class="label cursor-pointer">
              ...
              <span class="label-text">Join newsletters</span>
            </label>
          </div>
        </div>
        <!-- konto kustutamine -->
