  ...
  <div>
    <div class="pt-20">
      ...
      <div class="mx-auto bg-base-300 w-2/4 px-5 py-5 border border-primary-content rounded-3xl">
        <h1 class="text-center text-2xl font-bold text-primary-content mb-5">My Settings</h1>
        <!-- Mingi profiilikaart -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 justify-around text-primary-content gap-4">
          ...
          <div>
            <div class="flex flex-row items-center">
              ...
              <span class="text-lg">My Email</span>
            </div>
            <div class="flex flex-row items-center">
          ...
          <div>
            <div class="flex flex-row items-center">
              ...
              <span class="text-lg">My Number</span>
            </div>
            <div class="flex flex-row items-center">
          ...
          <div>
            <div class="flex flex-row items-center">
              ...
              <span class="text-lg">My Password</span>
            </div>
            <div class="flex flex-row items-center">
            ...
            <div class="col-start-1 col-end-3">
              <div class="form-control">
                <label class="label cursor-pointer">
                  ...
                  <span class="label-text text-base">Join newsletters</span>
                </label>
              </div>
            </div>
            <!-- konto kustutamine -->
