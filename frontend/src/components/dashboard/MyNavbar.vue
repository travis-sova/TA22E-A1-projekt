  ...
  <div class="navbar bg-primary text-primary-content">
    ...
    <div class="flex flex-col lg:flex-row-reverse gap-2 justify-end">
      <div class="form-control">
        <input type="text" :placeholder="$t('nav.search')" class="input input-bordered w-24 md:w-auto" />
      </div>
        ...
        <div tabindex="0" role="button" class="btn btn-ghost btn-square avatar">
          <div class="w-auto h-10">
            <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              width="48" height="48" viewBox="0, 0, 480, 500">
              <g id="svgg">
                <path
      ...
      <div class="dropdown dropdown-end">
        <div tabindex="0" role="button" class="btn btn-ghost p-0">
          <div class="w-12 h-auto shadow-lg object-contain">
